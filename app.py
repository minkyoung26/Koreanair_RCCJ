            ...
            if not filtered_df.empty:
                ...
                with c3:
                    if bound_col:
                        ...
                        fig3 = px.pie(
                            ...
                            title='3. BOUND별 점유비 (KE 한정)', hole=0.4
                        )
                ...
                with c4:
                    if 'Ticket Type' in merged_df.columns:
                        ...
                        fig4 = px.pie(tt_pie_df, values=val_col, names='Ticket Type', title='4. TRIP TYPE별 점유비 (KE 한정)', hole=0.4)
...
# ==========================================
    ...
    with st.expander("🔍 **6수송 대시보드 피벗 슬라이서 필터 설정**", expanded=True):
        ...
        all_sub_6 = sorted([str(x) for x in df_6[act_sub_c].dropna().unique()]) if act_sub_c and act_sub_c in df_6.columns else []
